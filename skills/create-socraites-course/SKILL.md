...
6. Give every substantive learning point at least one concrete example. Put examples in the exact collapsible form documented in the format reference. Add Mermaid diagrams, highlighted code, or a relevant YouTube video only when the medium improves the explanation.
